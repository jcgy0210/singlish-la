...
export default function SettingsPage() {
  ...
  return (
    <main className="min-h-screen p-4 md:p-8 bg-background-light dark:bg-background-dark">
      {pageCondition == 0 && (
        <div>
          <Header title="Settings" onClick={() => setPageCondition(1)}></Header>
          {/* Body */}
          <div className="w-full max-w-4xl mx-auto flex flex-col gap-4 text-text-light dark:text-text-dark">
            ...
            <div className="flex flex-col p-4">
              ...
              <div className="flex flex-row p-4">
                ...
                <button className="w-9" onClick={() => setPageCondition(2)}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
            ...
            <div className="flex flex-col p-4">
              ...
              <div className="flex flex-col p-4 gap-4">
                <div className="flex flex-row ">
                  ...
                  <button className="w-9" onClick={() => setPageCondition(3)}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                ...
                <div className="flex flex-row">
                  ...
                  <button className="w-9" onClick={() => setPageCondition(4)}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
      ...
      {pageCondition == 1 && <Menu onClose={() => setPageCondition(0)}></Menu>}

      {pageCondition == 2 && (
        <ProfileInfo onClose={() => setPageCondition(0)}></ProfileInfo>
      )}

      {pageCondition == 3 && (
        <FAQSection onClose={() => setPageCondition(0)}></FAQSection>
      )}

      {pageCondition == 4 && (
        <ContactUs onClose={() => setPageCondition(0)}></ContactUs>
      )}
    </main>
  );
}
